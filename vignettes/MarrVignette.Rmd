...
```{r byFeatures}
## Filtering the data by reproducible features (first 5 rows and columns)
MarrFilterData(Marr_output, by = "features")

## Filtering the data by reproducible sample pairs (first 5 rows and columns)
MarrFilterData(Marr_output, by = "samplePairs")

## Filtering the data by both features and sample pairs (first 5 rows and columns)
